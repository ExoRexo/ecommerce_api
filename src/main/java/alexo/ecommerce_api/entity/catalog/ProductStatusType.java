...
public class ProductStatusType {
     ...
     */
    @Transient
    public ProductStatusCode getStatusCodeEnum() {
        return EnumCodeMapper.fromCode(ProductStatusCode.class, code);
    }

    /**
     * Sets database code from enum value.
     */
    public void setStatusCodeEnum(ProductStatusCode codeEnum) {
