...
public class ProductCacheService {
    ...
    public Map<ProductStatusType.ProductStatusCode, ProductStatusType> getProductStatuses() {
        HashMap<ProductStatusType.ProductStatusCode, ProductStatusType> statuses = new HashMap<>();
